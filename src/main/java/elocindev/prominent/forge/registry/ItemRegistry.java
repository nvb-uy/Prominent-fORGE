...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> MAIN_MENU_DISC = 
        REGISTRY.register("music_disc_coniferus_forest", () -> new MainMenuDisc(SoundRegistry.CONIFERUS_FOREST, new Item.Properties().stacksTo(1).tab(ProminentLoader.PROMINENT_TAB)));
